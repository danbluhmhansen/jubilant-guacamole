namespace RolePlayingGame.Server
{
	...
	using RolePlayingGame.Server.Configuration;
	using RolePlayingGame.Server.Hubs;
	...
	public class Startup
	{
		...
		{
			services.AddAutoMapper(expression => expression.MapConfiguration(), typeof(PlayerCharacterModel));
