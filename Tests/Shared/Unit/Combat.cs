namespace RolePlayingGame.Tests
{
	...
	public class Combat
	{
		...
		{
			new TestCaseData(6554, new Human(), new Attack(1000, 1000), new BodyPart("Body", 160, 500, BodyPartStatus.Impaired)),
			new TestCaseData(9663, new Human(), new Attack(1000, 1000), new BodyPart("Left arm", 80, 500, BodyPartStatus.Normal)),
		};

		[TestCaseSource(nameof(Data))]
		public void Defence(int seed, ICreature creature, IAttack attack, IBodyPart expected)
		{
			// Arrange
